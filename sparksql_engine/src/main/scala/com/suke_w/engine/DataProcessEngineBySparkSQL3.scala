 ...
 * 2.支持复杂字段类型，数组
 * 3.支持在sql中调用HTTP接口（使用redis验证）
 */
object DataProcessEngineBySparkSQL3 {
  def main(args: Array[String]): Unit = {
    ...
    var funcInfo = "[{\"name\":\"m1\",\"mainClass\":\"com.suke_w.udfs.MyUDFByRedisNew\",\"param\":\"(String)\",\"returnType\":\"string\"}]" //json数组,需要使用的udf
